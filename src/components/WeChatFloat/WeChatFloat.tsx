...
const WECHAT_QR_URL = import.meta.env.BASE_URL + 'wechat-qr.png';
      ...
      {isHovered && (
        <div className="qr-popup">
          <div className="qr-content">
            <img src={WECHAT_QR_URL} alt="微信二维码" className="qr-image" />
            <p className="qr-hint">微信扫码发送 "leetcode"<br/>加入算法交流群</p>
          </div>
        </div>
      )}
    </div>
